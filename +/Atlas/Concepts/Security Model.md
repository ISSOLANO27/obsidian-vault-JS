...
- Allowing server-side languages to directly manipulate the browser would be a massive security risk.
    
- Browsers enforce strict boundaries: only JavaScript (or WebAssembly) can run client-side.
-
